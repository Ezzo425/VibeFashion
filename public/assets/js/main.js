(function ($) {
    ...
    $(document).ready(function ($) {
        ...
        $(document).on("submit", ".cart-async-form", function (event) {
            ...
            fetch(form.attr("action"), {
                ...
                .then(function (data) {
                    ...
                    if (form.hasClass("cart-remove-form")) {
                        line.fadeOut(180, function () {
                            line.remove();
                        });
                    }

                    if (data.line_total && line.length) {
                        line.find(".cart-line-total").text(
                            "$" + data.line_total,
                        );
                    }

                    if (data.total) {
                        $(".cart-subtotal, .cart-total").text("$" + data.total);
                    }
